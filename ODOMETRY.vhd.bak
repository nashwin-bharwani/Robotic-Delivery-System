...
BEGIN
	...
	PORT MAP (
		clock0 => NOT(CLOCK),
		address_a => THETA(10 DOWNTO 0), -- input is angle
		q_a => COS_THETA -- output is sin(angle)
	);
	...
	-- The two inputs already filled in here are probably
	-- appropriate, but you can change them if needed.
	...
	PORT MAP (
		data     => OUTDATA,  -- drive this register
